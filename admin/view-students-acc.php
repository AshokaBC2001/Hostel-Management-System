...
.table-wrapper {
    overflow-x: auto;
    padding-bottom: 10px; /* space for scrollbar inside card */
}
</style>
</head>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 align-self-center">
                <h2 class="mb-0 font-weight-bold mt-2">Student Accounts</h2>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card shadow-sm border-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0 font-weight-bold mt-2">All Registered Accounts in System</h4>
            </div>
            <div class="card-body">

                <!-- Common Search Bar -->
                <input type="text" class="form-control search-box" id="searchAll" placeholder="Search Students...">

                <!--------------------- BOYS TABLE ------------------------>
                <div class="card shadow-sm border-0 mt-4">
                    <div class="card-header">
                        <h5 class="mb-0 font-weight-bold mt-1">Boys (Male)</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-wrapper">
                            <table class="table table-hover table-bordered no-wrap" id="boysTable">
                                ...
                                <tbody>
                                <?php
                                $query = "SELECT * FROM userregistration ORDER BY firstName ASC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="actions-cell">
                                            <a href="view-students-acc.php?del=<?php echo htmlentities($row->id); ?>"
                ...
                <div class="card shadow-sm border-0 mt-5">
                    <div class="card-header">
                        <h5 class="mb-0 font-weight-bold mt-1">Girls (Female)</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-wrapper">
                            <table class="table table-hover table-bordered no-wrap" id="girlsTable">
                                ...
                                $cnt = 1;
                                while($row = $res->fetch_object()) {
                                    if(strtoupper($row->gender) === 'FEMALE') {
                                ?>
                                    <tr>
                                        <td><?php echo $cnt++; ?></td>
                                        <td><?php echo htmlentities($row->regNo); ?></td>
