...
<nav class="sidebar-nav">
  <ul id="sidebarnav">
    ...
    <li class="sidebar-item">
      <a class="sidebar-link" href="register-student.php" aria-expanded="false">
    ...
    <li class="sidebar-item">
      <a class="sidebar-link" href="view-students-acc.php" aria-expanded="false">
        <i class="fas fa-user-circle"></i>
        <span class="hide-menu">All Student Details</span>
      </a>
    </li>

    <li class="sidebar-item">
      <a class="sidebar-link" href="manage-students.php" aria-expanded="false">
        <i class="fas fa-users"></i>
        <span class="hide-menu">Manage Residents</span>
      </a>
    </li>

    <li class="sidebar-item">
      <a class="sidebar-link" href="manage-rooms.php" aria-expanded="false">
    ...
    <li class="sidebar-item">
      <a class="sidebar-link" href="student-inquires.php" aria-expanded="false">
        <i class="fas fa-exclamation-triangle"></i>
        <span class="hide-menu">Student Inquires</span>
      </a>
    </li>
  </ul>
</nav>
